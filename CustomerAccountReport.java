  ...
  *   Authors: Wesley Eaton (tnw777), Meagan Folmar (zpy558), Adam Garibay (rsg825)
  *   Date: 4/26/2018 2226
  *   Code version: 1.0
  * 
 ...
 /*declaring instance variables*/
    ...
    public static void closeFiles() throws IOException 
    {
      /*try closing customers and securities files and throws exception if unable to*/
        ...
        {
            System.err.println("Error closing input file."); //print out message if ioException is thrown
            ioException.printStackTrace( );
